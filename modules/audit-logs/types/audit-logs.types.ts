...
export const AUDIT_ACTION_LABELS: Record<AuditAction, string> = {
  ...
  DEVICE_TRUSTED: 'Dispositivo de confianza',
  SUSPICIOUS_LOGIN_DETECTED: 'Inicio de sesión desde nueva ubicación',
  ...
  EMAIL_CHANGE_REQUESTED: 'Solicitud de cambio de email',
